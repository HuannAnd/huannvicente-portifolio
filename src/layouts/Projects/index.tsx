  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="w-auto"
      >
        <h1 className="text-[clamp(100px,_10vw,_200px)] pl-[3vw] font-semibold text-white uppercase">
          Projects{""}
      ...
      >
        <small className="py-10 uppercase bg-transparent col-span-12 font-light select-none">Developed</small>
        {developed.map((project, i) => <Project key={i} nTh={i + 1} project={project} />)}
        <small className="py-10 uppercase bg-transparent col-span-12 font-light select-none">Prototyped</small>
