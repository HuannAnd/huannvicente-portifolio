...
function Follower({ title, isLoading }: FollowerProps, ref: React.ForwardedRef<AnimationScope<SVGSVGElement>>) {
  ...
  return (
    <motion.div
      className="pointer-events-none fixed lg:visible md:invisible sm:invisible select-none z-50 mix-blend-difference w-[102px] aspect-square grid place-content-center m-0 left-0 top-0"
    ...
    >
      <motion.span
        className='font-normal text-[16px] absolute w-full text-center text-white/60 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'
