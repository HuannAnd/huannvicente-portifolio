    ...
    >
      <div className="clip-around w-full h-full bg-transparent flex flex-col">
        <LettersSlideInOnView trigger="#about" threshold={20}>
          <h1 className='relative @desktop:w-auto @mobileAndTablet:w-full @mobileAndTablet:text-center @mobileAndTablet:mx-auto @mobileAndTablet:block @desktop:ml-auto text-white @desktop:inline-block @desktop:overflow-hidden'>
            Delivering products
            <br />
            with respect
          </h1>
        </LettersSlideInOnView>
        <article id="about-me" className="grow grid sticky top-0 grid-cols-6 mt-32 gap-4 py-[3vw] align-baseline font-light z-20 col-start-6">
          <Polygon data-scroll data-scroll-speed="-0.2" trigger='#about' className='-z-10' isRegular vertexes={4} radius={200} />
          <TextFadeInOnView className='sticky top-0 col-start-2 @desktop:col-span-1 @mobileAndTablet:col-span-2' delayInSeconds={.2} trigger='#about'>
          ...
          <TextFadeInOnView className='col-start-3 @desktop:col-span-1 @mobileAndTablet:col-span-2' trigger='#about' delayInSeconds={.4}>
