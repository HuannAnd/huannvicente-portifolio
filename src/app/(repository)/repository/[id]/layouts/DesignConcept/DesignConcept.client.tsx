...
export default function ClientDesignConcept({ }: Props) {
  return (
    ...
    >
      ...
      <div className="min-h-[55vmin] gap-2 pt-@container @desktop:col-span-4 @desktop:col-start-1 @mobileAndTablet:col-start-2 @mobileAndTablet:flex @mobileAndTablet:flex-col @desktop:grid @desktop:grid-cols-2">
