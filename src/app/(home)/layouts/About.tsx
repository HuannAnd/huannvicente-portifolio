  ...
  return (
    ...
    >
      <div className="w-full  grid grid-cols-6 gap-4 mb-[3vw] bg-transparent">
        ...
        <article id="about-me" className="@desktop:col-span-2 sticky top-0 self-start @tablet:col-span-3 @desktop:col-start-2 @tablet:col-start-2 @mobile:col-span-full  @mobileAndTablet:mt-0  gap-4 z-20 col-start-6">
          ...
          <TextFadeInOnView delayInSeconds={.2} trigger='#about'>
            <p className='@desktop:text-[1rem] @mobileAndTablet:text-[1.25rem] leading-[150%] mb-4'>I&apos;m Frontend developer, from Brazil</p>
            <p className='@desktop:text-[1rem] @mobileAndTablet:text-[1.25rem] leading-[150%]'>
            ...
            <p className='@desktop:text-[1rem] @mobileAndTablet:text-[1.25rem] mb-4 leading-[150%]'>
