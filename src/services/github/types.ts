...
declare namespace GithubApi {
  ...
  export type GithubUserReposBody = GithubRepoData[]

  export type GithubRepoBody = GithubRepoData
  ...
  export type GithubLanguagesBody = Record<string, number>
}
